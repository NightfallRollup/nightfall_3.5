...
COPY nightfall-client/docker-client-bp-worker-entrypoint.sh ./docker-entrypoint.sh
COPY nightfall-client/package.json nightfall-client/package-lock.json ./
